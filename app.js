...
(() => {
  ...
  const DISCS = [
    ...
    },
    {
      id: 'my-jigsaw-puzzle',
      name: 'マイジグソーパズル',
      description: '好きな写真からジグソーパズルを作って遊べるPWA。オフラインでもプレイ可能。',
      color: '#AB47BC',
      url: 'https://junia2009.github.io/My_Jigsaw_Puzzle/',
      repo: 'https://github.com/junia2009/My_Jigsaw_Puzzle',
      tags: ['JS', 'game', 'PWA'],
      category: 'ゲーム',
    },
    {
      id: 'my-suica-game',
      name: 'スライム合成パズル',
      description: 'Matter.js物理演算のスイカゲーム風合成パズル。深海テーマでスライムを合体させて最上位を目指す。',
      color: '#76FF03',
      url: 'https://junia2009.github.io/my_suica_game/',
      repo: 'https://github.com/junia2009/my_suica_game',
      tags: ['Canvas', 'game', 'PWA'],
      category: 'ゲーム',
    },
    {
      id: 'play-the-tennis',
      name: 'テニスウェブゲーム',
      description: 'バーチャルスティック操作と4種のショットで戦うブラウザテニスゲーム。',
      color: '#C6FF00',
      url: 'https://junia2009.github.io/play_the_tennis/',
      repo: 'https://github.com/junia2009/play_the_tennis',
      tags: ['Canvas', 'game', 'PWA'],
      category: 'ゲーム',
    },
    {
      id: 'smart-home-db',
      name: 'スマートホームDB',
      description: 'SwitchBot HUB2の温度・湿度・照度を15分ごとに記録し、グラフで可視化するダッシュボード。',
      color: '#64FFDA',
      url: 'https://junia2009.github.io/smart_home_db/',
      repo: 'https://github.com/junia2009/smart_home_db',
      tags: ['JS', 'IoT', 'PWA'],
      category: 'その他',
    },
    {
      id: 'higashikurume-gomi',
      name: '東久留米ごみナビ',
      description: '東久留米市のごみ分別検索と収集日カレンダー。オフライン対応PWA。',
      color: '#8BC34A',
      url: 'https://junia2009.github.io/higashikurume_gomi/',
      repo: 'https://github.com/junia2009/higashikurume_gomi',
      tags: ['JS', 'tool', 'PWA'],
      category: 'その他',
    },
    {
      id: 'home-loan-rate',
      name: '住宅ローン金利ナビ',
      description: '各銀行の変動金利を比較し、借入額・期間から返済額をシミュレーションできるツール。',
      color: '#26A69A',
      url: 'https://junia2009.github.io/Home_loan_rate/',
      repo: 'https://github.com/junia2009/Home_loan_rate',
      tags: ['Next.js', 'tool', 'PWA'],
      category: 'その他',
    },
    {
      id: 'vocabulary-book',
      name: '単語帳',
      description: '表裏ペアで覚える汎用フラッシュカード単語帳。localStorage保存でオフライン学習可能。',
      color: '#7E57C2',
      url: 'https://junia2009.github.io/vocabulary_book/',
      repo: 'https://github.com/junia2009/vocabulary_book',
      tags: ['JS', 'study', 'PWA'],
      category: 'その他',
    },
    {
      id: 'my-tasks',
      name: 'Abyss タスク管理',
      description: '深海テーマのスマホ特化タスク管理PWA。データはすべて端末内に保存。',
      color: '#3D5AFE',
      url: 'https://junia2009.github.io/my-tasks/',
      repo: 'https://github.com/junia2009/my-tasks',
      tags: ['React', 'tool', 'PWA'],
      category: 'その他',
    },
    {
